 ...
 *
 * Modos:
 *   - "Entrar": login por e-mail/senha (Supabase Auth, decisão 2A) com checagem
 *     de perfil e de bloqueio ANTES de liberar o painel;
 *   - "Criar conta": cadastro do colaborador — novo acesso entra como Recepção
 *     (a promoção para Dentista é feita pela administradora no banco).
 *
 * Erros tratados em PT-BR: credenciais inválidas, usuário bloqueado, e-mail não
 * confirmado, cadastro desativado, senha fraca, e-mail já registrado e rede.
 */
